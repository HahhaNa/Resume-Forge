...
const dict = {
  en: {
    ...
    whatNow: "What now",
    whatNowHint: "Two things this run can leave behind. Neither happens on its own, and they are independent — do one, both, or neither.",
    stepVariant: "Make it a résumé you can use",
    stepVariantHint: "It becomes an ordinary variant: editable on the Resume tab, duplicable later, and that is where you export .tex, open Overleaf, or save a PDF.",
    stepPosting: "Keep the posting with the application",
    openInResume: "Open in Résumé",
    rewordWaiting: "A rewording is waiting for you",
    fitScore: "Fit",
    requiredAnswered: "required answered",
    readIt: "Read it",
    reading: "Reading the posting…",
    readFrom: "read from",
    readHint: "Paste a link from Greenhouse, Lever, Ashby, Workable, SmartRecruiters, Recruitee, Breezy or Teamtailor and it reads the posting itself. Anywhere else, paste the text below.",
    jdNotAllowed: "That board can't be read from a link — it renders with JavaScript and blocks server requests. Paste the posting below instead.",
    jdNotUrl: "That doesn't look like a link.",
    jdNotHttps: "Only https links can be read.",
    jdRedirected: "That link forwards to the company's own careers site, which can't be read from a link. Paste the posting below instead.",
    jdBlocked: "The board refused the request. Paste the posting below instead.",
    jdUnreachable: "Could not reach it. Paste the posting below instead.",
    jdEmpty: "Nothing readable came back. Paste the posting below instead.",
    reword: "Reword",
    rewording: "Rewording…",
  ...
  zh: {
    ...
    chosenLines: "放進頁面的句子",
    whatNow: "接下來",
    whatNowHint: "這次執行可以留下兩樣東西。兩件都不會自己發生，而且互相獨立 —— 做一個、兩個都做、或都不做都可以。",
    stepVariant: "變成一份可以用的履歷",
    stepVariantHint: "它會成為一個普通變體：可以在 Resume 分頁編輯、之後複製，而 .tex、Overleaf、存 PDF 也都在那裡。",
    stepPosting: "把職缺留在這筆申請下",
    openInResume: "到 Resume 分頁",
    rewordWaiting: "有一則改寫等你決定",
    fitScore: "契合度",
    requiredAnswered: "項必要條件已回答",
    readIt: "讀取",
    reading: "讀取職缺中…",
    readFrom: "讀自",
    readHint: "貼上 Greenhouse、Lever、Ashby、Workable、SmartRecruiters、Recruitee、Breezy 或 Teamtailor 的連結，它會自己把職缺讀進來。其他站請直接把內容貼在下面。",
    jdNotAllowed: "這個站沒辦法從連結讀 —— 它用 JavaScript 產生內容並且擋伺服器請求。請直接把職缺貼在下面。",
    jdNotUrl: "這看起來不像一個連結。",
    jdNotHttps: "只能讀 https 連結。",
    jdRedirected: "這個連結會轉到公司自己的徵才頁，那個沒辦法從連結讀。請直接把職缺貼在下面。",
    jdBlocked: "對方拒絕了這個請求。請直接把職缺貼在下面。",
    jdUnreachable: "連不上。請直接把職缺貼在下面。",
    jdEmpty: "沒有讀到可用的內容。請直接把職缺貼在下面。",
    reword: "換句話說",
    rewording: "改寫中…",
